    ...
    if (example === 1) {
      ...
      return (
        <RadioButtonRN
          ...
          selectedBtn={(e) => this.setState({ res: e })}
          circleSize={16}
          icon={<Icon name="rocket" size={25} color="#a82c3a" />}
        />
      );
    } else if (example === 6) {
      return (
      ...
      return (
        <RadioButtonRN
          ...
          selectedBtn={(e) => this.setState({ res: e })}
          circleSize={16}
          icon={<Icon name="rocket" size={25} color="#2c9dd1" />}
        />
      );
    }
  }
      ...
      <View>
        <View style={{ margin: 10, flexDirection: "row" }}>
          <TouchableOpacity
            ...
            style={[
              styles.types,
              { backgroundColor: example === 1 ? "#ccc" : "#fff" },
            ]}
          ...
          <TouchableOpacity
            ...
            style={[
              styles.types,
              { backgroundColor: example === 2 ? "#ccc" : "#fff" },
            ]}
            onPress={() => this.setState({ example: 2 })}
          >
            <Text>without Box</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            style={[
              styles.types,
              { backgroundColor: example === 3 ? "#ccc" : "#fff" },
            ]}
        ...
        <View style={{ margin: 10, flexDirection: "row" }}>
          <TouchableOpacity
            ...
            style={[
              styles.types,
              { backgroundColor: example === 4 ? "#ccc" : "#fff" },
            ]}
          ...
          <TouchableOpacity
            ...
            style={[
              styles.types,
              { backgroundColor: example === 5 ? "#ccc" : "#fff" },
            ]}
          ...
          <TouchableOpacity
            ...
            style={[
              styles.types,
              { backgroundColor: example === 6 ? "#ccc" : "#fff" },
            ]}
          ...
          <TouchableOpacity
            ...
            style={[
              styles.types,
              { backgroundColor: example === 7 ? "#ccc" : "#fff" },
            ]}
        ...
        <View style={{ top: 50, padding: 20 }}>
          <Text style={{ fontSize: 13 }}>Selected your color:</Text>

          {this._renderRadioBtn()}
        </View>
        {this.state.res && (
          <View style={{ top: 100, width: "100%", alignItems: "center" }}>
            <Text style={{ fontSize: 13 }}>Selected Color:</Text>
